       ...
       <van-nav-bar :title="title" left-arrow class="nav-title"></van-nav-bar>
        <van-tabs scrollspy sticky>
            <van-tab title="基础信息">
             ...
             <van-tab title="图文描述">
                <h2 class="title">图文描述</h2>
                <div class="formWarp">
                    <h3 class="subTitle">车辆图片</h3>
                    <div class="lists">
                        <van-image class="item" v-for="(item,index) in data.carPic"
                        :src="item"
                        :key="index"
                        @click="showImagePreview(item)"/>
                    </div>
                    <h3 class="subTitle">车辆视频</h3>
                    <div class="lists">
                        <div v-for="(item,index) in data.carVideo" class="item" :key="index">
                    ...
                    <h3 class="subTitle">行驶证</h3>
                    <div class="lists">
                         <van-image class="item" v-for="(item,index) in data.drivingLicense"
                        :src="item"
                        :key="index"
                        @click="showImagePreview(item)"
                        />
